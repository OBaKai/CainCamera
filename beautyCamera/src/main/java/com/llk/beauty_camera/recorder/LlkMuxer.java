...
import com.llk.beauty_camera.recorder.audio.LlkAudioRecorder;
import com.llk.beauty_camera.recorder.video.LlkVideoRecorder;
import com.llk.beauty_camera.recorder.video.VideoParams;

public class LlkMuxer implements OnRecordListener {

    private static final String TAG = LlkMuxer.class.getSimpleName();
    ...
    // 音频录制器
    private final LlkAudioRecorder mAudioRecorder;
    // 视频录制器
    private final LlkVideoRecorder mVideoRecorder;
    // 是否支持音频录制
    ...
    public LlkMuxer(OnRecordStateListener listener) {
        mRecordStateListener = listener;
        mVideoRecorder = new LlkVideoRecorder();
        mVideoRecorder.setOnRecordListener(this);

        mAudioRecorder = new LlkAudioRecorder();
